...
const phases = [
  {
    ...
    status: 'live',
    img: '/card-barrel.png',
    desc: 'The flagship bluffing game. 2–4 players, commit-reveal cards, Russian Roulette. Basic Mode live on Celo Sepolia. Stake USDC, last player alive wins the pot.',
    items: ['Basic Mode live', 'USDC stakes', 'Celo Sepolia', '8 characters'],
  },
  {
    date: 'July 2026',
    title: 'Devil Mode',
    status: 'next',
    img: '/card-barrel.png',
    desc: 'One Devil card lurks in the deck. Play it and survive — or watch every other player face the revolver simultaneously.',
    items: ['Devil card wildcard', 'Multi-spin on reveal', 'Same stake system', 'Celo Sepolia'],
  },
  {
    date: 'August 2026',
    title: 'Chaos Mode',
    status: 'upcoming',
    img: '/card-barrel.png',
    desc: 'Winners shoot opponents. The Chaos card makes everyone pull the trigger at once. The most unpredictable mode.',
    items: ['Shoot the winner', 'Chaos multi-trigger', 'Master wildcard', 'Celo Mainnet'],
  },
  {
    ...
    items: ['20+ unique characters', 'Reduced platform fees', 'Exclusive tables', 'ERC-721 on Celo'],
  },
  {
    ...
    status: 'upcoming',
    img: '/token.png',
    desc: 'The game currency. Earn by playing, stake for governance. Use as alternative to USDC for table stakes.',
    items: ['Play-to-earn', 'Governance', 'Alternative stakes', 'Celo native'],
  },
  {
    date: 'October 2026',
    title: 'Theme NFTs',
